!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), x = o(d), _ = e(c, v, 3), b = u(x.length), m = 0, S = r ? h(n, b) : a ? h(n, 0) : void 0; b > m; m++)
          if ((p || m in x) && ((g = _((y = x[m]), m, d)), t))
            if (r) S[m] = g;
            else if (g)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(9)) {
      var o = r(30),
        ...
        Vt = function(t, n) {
          return Wt(t, (n = _(n, !0))) ? p(2, t[n]) : U(t, n);
        },
        Bt = function(t, n, r) {
          return !(Wt(t, (n = _(n, !0))) && S(r) && b(r, 'value')) || b(r, 'get') || b(r, 'set') || r.configurable || (b(r, 'writable') && !r.writable) || (b(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      _t || ((B.f = Vt), (V.f = Bt)),
        c(c.S + c.F * !_t, 'Object', { getOwnPropertyDescriptor: Vt, defineProperty: Bt }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
          ...
          _
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (S(r)) {
                  if (!(r instanceof q || 'ArrayBuffer' == (a = m(r)) || 'SharedArrayBuffer' == a)) return bt in r ? It(v, r) : At.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, p) {
      ...
      if (i(d)) {
        for (h = c(t.length); h > _; _++) if ((g = n ? x(u((v = t[_]))[0], v[1]) : x(t[_])) === f || g === s) return g;
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      } else (_ = y.getConstructor(n, t, g, b)), u(_.prototype, r), (c.NEED = !0);
      return h(_, t), (S[t] = _), o(o.G + o.W + o.F * (_ != x), S), d || y.setStrong(_, t, g), _;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((x = { values: w ? F : m('values'), keys: g ? F : m('keys'), entries: M }), d)) for (_ in x) _ in O || i(O, _, x[_]);
  ...
  function(t, n, r) {
    ...
    (p && h) ||
      ...
      'process' == r(23)(l)
        ...
        : v
        ? ((i = (o = new v()).port2), (o.port1.onmessage = _), (e = u(i.postMessage, i, 1)))
  ...
  function(t, n, r) {
    ...
    d(b, 'ArrayBuffer'), d(m, 'DataView'), c(m[x], u.VIEW, !0), (n.ArrayBuffer = b), (n.DataView = m);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = u(t), a = arguments.length, f = 1, s = o.f, l = i.f; a > f; )
              for (var p, h = c(arguments[f++]), v = s ? e(h).concat(s(h)) : e(h), y = v.length, g = 0; y > g; ) l.call(h, (p = v[g++])) && (r[p] = h[p]);
            return r;
          }
        : a;
  },
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      q = function(t, n, r) {
        return (
          ...
          (n = S(n, !0)),
          _(r),
          i(W, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = E(r, { enumerable: w(0, !1) }))) : (i(t, R) || T(t, R, w(1, {})), (t[R][n] = !0)), K(t, n, r)) : T(t, n, r)
        );
      },
      J = function(t, n) {
        _(t);
        for (var r, e = d((n = m(n))), o = 0, i = e.length; i > o; ) q(t, (r = e[o++]), n[r]);
        return t;
      },
      $ = function(t) {
        var n = C.call(this, (t = S(t, !0)));
        return !(this === B && i(W, t) && !i(V, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, R) && this[R][t])) || n);
      },
      H = function(t, n) {
        if (((t = m(t)), (n = S(n, !0)), t !== B || !i(W, n) || i(V, n))) {
          var r = I(t, n);
          return !r || !i(W, n) || (i(t, R) && t[R][n]) || (r.enumerable = !0), r;
        }
      },
      Z = function(t) {
        for (var n, r = A(m(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == R || n == f || e.push(n);
        return e;
      },
      Q = function(t) {
        for (var n, r = t === B, e = A(r ? V : m(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(B, n)) || o.push(W[n]);
        return o;
      };
    G ||
      (a(
        (j = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(V, r), i(this, R) && i(this[R], t) && (this[R][t] = !1), K(this, t, w(1, r));
            };
          return u && z && K(B, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = $),
      (r(50).f = Q),
      u && !r(30) && a(B, 'propertyIsEnumerable', $, !0),
      (y.f = function(t) {
        return Y(v(t));
      })),
    ...
    c(c.S + c.F * !G, 'Symbol', {
      ...
      j.prototype[L] || r(14)(j.prototype, L, j.prototype.valueOf),
      p(j, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x = []; ; ) {
            ...
            if (null === _) break;
            if ((x.push(_), !g)) break;
            '' === String(_[0]) && (l.lastIndex = c(p, i(l.lastIndex), d));
          }
          for (var b, m = '', S = 0, w = 0; w < x.length; w++) {
            _ = x[w];
            for (var E = String(_[0]), O = f(s(u(_.index), p.length), 0), P = [], F = 1; F < _.length; F++) P.push(void 0 === (b = _[F]) ? b : String(b));
            var M = _.groups;
            if (h) {
      ...
      return (
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, m = 0, S = []; m < p.length; ) {
              x.lastIndex = h ? m : 0;
              var w,
                E = a(x, h ? p : p.slice(m));
              if (null === E || (w = l(c(x.lastIndex + (h ? 0 : m)), p.length)) === b) m = u(p, m, g);
              else {
                if ((S.push(p.slice(b, m)), S.length === _)) return S;
                for (var O = 1; O <= E.length - 1; O++) if ((S.push(E[O]), S.length === _)) return S;
                m = b = w;
              }
            }
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      _ = (t.exports = r(58)('WeakMap', d, x, f, !0, !0));
    p &&
      h &&
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        _ = u[d],
        b = _ && _.prototype;
      if (b && (b[s] || c(b, s, p), b[l] || c(b, l, d), (a[d] = p), x)) for (g in e) b[g] || i(b, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        var b = Object.getPrototypeOf,
          m = b && b(b(I([])));
        m && m !== e && o.call(m, u) && (_ = m);
        var S = (x.prototype = g.prototype = Object.create(_));
        function w(t) {
          ...
          ((s = !p && b && void 0 !== b[f]) && c(x, f)) ||
            ...
            (x[f] =
              h && 'function' != typeof b[f]
                ...
                ? i(Function.call, l)
                : l),
            y && (((x.virtual || (x.virtual = {}))[f] = l), n & t.R && _ && !_[f] && u(_, f, l)));
      };
          ...
          a = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var e, a, f, s, l, p, h, v, y, g, d, x, _, b, m;
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 92:
                          ...
                          return (_ = 0), (t.next = 96), s.getNumKids();
                        case 96:
                          b = t.sent;
                        case 97:
                          if (!(_ < b)) {
                          ...
                          return (t.t5 = c), (t.next = 101), s.getKid(_);
                        case 101:
