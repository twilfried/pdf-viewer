!(function(t) {
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = u(t), f = arguments.length, a = 1, s = o.f, l = i.f; f > a; )
              for (var h, p = c(arguments[a++]), v = s ? e(p).concat(s(p)) : e(p), y = v.length, d = 0; y > d; ) l.call(p, (h = v[d++])) && (r[h] = p[h]);
            return r;
          }
        : f;
  },
  ...
  function(t, n, r) {
    ...
    t.exports = function(t) {
      return function(n) {
        for (var r, u = o(n), c = e(u), f = c.length, a = 0, s = []; f > a; ) i.call(u, (r = c[a++])) && s.push(t ? [r, u[r]] : u[r]);
        return s;
      };
    };
  },
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (r = E(r, { enumerable: _(0, !1) }))) : (i(t, L) || I(t, L, _(1, {})), (t[L][n] = !0)), Y(t, n, r)) : I(t, n, r)
        );
      },
      $ = function(t, n) {
        b(t);
      ...
      K = function(t) {
        ...
        return !(this === U && i(B, t) && !i(W, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, L) && this[L][t])) || n);
      },
      X = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== U || !i(B, n) || i(W, n))) {
          var r = A(t, n);
          return !r || !i(B, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r;
        }
      },
      Q = function(t) {
        for (var n, r = j(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == L || n == a || e.push(n);
        return e;
      },
      Z = function(t) {
        for (var n, r = t === U, e = j(r ? W : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    G ||
      (f(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(W, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), Y(this, t, _(1, r));
            };
          return u && z && Y(U, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = K),
      (r(50).f = Z),
      u && !r(30) && f(U, 'propertyIsEnumerable', K, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, d, g, m, b;
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (r = '../TestFiles/'),
                              (e = 'BusinessCardTemplate.pdf'),
                              (o = 'BusinessCard.pdf'),
                              (t.next = 7),
                              n.initialize()
                            );
                          case 7:
                            return (t.next = 9), n.PDFDoc.createFromURL(r + e);
                          case 9:
                            return (i = t.sent).initSecurityHandler(), i.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 15), n.ContentReplacer.create();
                          case 15:
                            return (u = t.sent), (t.next = 18), i.getPage(1);
                          case 18:
                            return (c = t.sent), (t.next = 21), n.Image.createFromURL(i, r + 'peppers.jpg');
                          case 21:
                            return (f = t.sent), (t.next = 24), c.getMediaBox();
                          case 24:
                            return (a = t.sent), (t.next = 27), f.getSDFObj();
                          case 27:
                            return (s = t.sent), (t.next = 30), u.addImage(a, s);
                          case 30:
                            return (t.next = 32), u.addString('NAME', 'John Smith');
                          case 32:
                            return (t.next = 34), u.addString('QUALIFICATIONS', 'Philosophy Doctor');
                          case 34:
                            return (t.next = 36), u.addString('JOB_TITLE', 'Software Developer');
                          case 36:
                            return (t.next = 38), u.addString('ADDRESS_LINE1', '#100 123 Software Rd');
                          case 38:
                            return (t.next = 40), u.addString('ADDRESS_LINE2', 'Vancouver, BC');
                          case 40:
                            return (t.next = 42), u.addString('PHONE_OFFICE', '604-730-8989');
                          case 42:
                            return (t.next = 44), u.addString('PHONE_MOBILE', '604-765-4321');
                          case 44:
                            return (t.next = 46), u.addString('EMAIL', 'info@pdftron.com');
                          case 46:
                            return (t.next = 48), u.addString('WEBSITE_URL', 'http://www.pdftron.com');
                          case 48:
                            return (t.next = 50), u.process(c);
                          case 50:
                            return (t.next = 52), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 52:
                            (l = t.sent), saveBufferAsPDFDoc(l, o), console.log('Done. Result saved as ' + o), (t.next = 60);
                            break;
                          case 57:
                            (t.prev = 57), (t.t0 = t.catch(0)), console.log(t.t0);
                          case 60:
                            return (
                              (t.prev = 60),
                              console.log('Beginning Content Replacer Test'),
                              (h = '../TestFiles/'),
                              (p = 'newsletter.pdf'),
                              (v = 'newsletterReplaced.pdf'),
                              (t.next = 67),
                              n.initialize()
                            );
                          case 67:
                            return (t.next = 69), n.PDFDoc.createFromURL(h + p);
                          case 69:
                            return (y = t.sent).initSecurityHandler(), y.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 75), n.ContentReplacer.create();
                          case 75:
                            return (d = t.sent), (t.next = 78), y.getPage(1);
                          case 78:
                            return (g = t.sent), (t.next = 81), g.getMediaBox();
                          case 81:
                            return (m = t.sent), (t.next = 84), d.addText(m, 'The quick onyx goblin jumps over the lazy dwarf');
                          case 84:
                            return (t.next = 86), d.process(g);
                          case 86:
                            return (t.next = 88), y.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 88:
                            (b = t.sent), saveBufferAsPDFDoc(b, v), console.log('Done. Result saved as ' + v), (t.next = 96);
                            break;
                          case 93:
                            (t.prev = 93), (t.t1 = t.catch(60)), console.log(t.t1);
                          case 96:
                          case 'end':
                            return t.stop();
                        }
