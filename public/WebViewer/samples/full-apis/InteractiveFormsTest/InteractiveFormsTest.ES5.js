!(function(t) {
          ...
          m
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = S(e)) || 'SharedArrayBuffer' == a)) return bt in e ? Mt(v, e) : It.call(v, e);
                  (i = e), (p = Et(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = u(t), a = arguments.length, f = 1, s = o.f, l = i.f; a > f; )
              for (var p, h = c(arguments[f++]), v = s ? r(h).concat(s(h)) : r(h), y = v.length, d = 0; y > d; ) l.call(h, (p = v[d++])) && (e[p] = h[p]);
            return e;
          }
        : a;
  },
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      Y =
        ...
        s(function() {
          ...
          : k,
      q = function(t) {
        var n = (B[t] = F(j.prototype));
        return (n._k = t), n;
      },
      H =
        V && 'symbol' == r(j.iterator)
          ? function(t) {
              return 'symbol' == r(t);
            }
          : function(t) {
      ...
      $ = function(t, n, e) {
        return (
          ...
          (n = w(n, !0)),
          m(e),
          i(B, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = F(e, { enumerable: _(0, !1) }))) : (i(t, R) || k(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, e)) : k(t, n, e)
        );
      },
      J = function(t, n) {
        m(t);
        for (var e, r = g((n = S(n))), o = 0, i = r.length; i > o; ) $(t, (e = r[o++]), n[e]);
        return t;
      },
      K = function(t) {
        var n = D.call(this, (t = w(t, !0)));
        return !(this === U && i(B, t) && !i(W, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, R) && this[R][t])) || n);
      },
      X = function(t, n) {
      ...
      Q = function(t) {
        for (var n, e = t === U, r = I(e ? W : S(t)), o = [], u = 0; r.length > u; ) !i(B, (n = r[u++])) || (e && !i(U, n)) || o.push(B[n]);
        return o;
      };
    V ||
      (a(
        (j = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === U && n.call(W, e), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, _(1, e));
            };
      ...
      (e(45).f = K),
      (e(50).f = Q),
      u && !e(30) && a(U, 'propertyIsEnumerable', K, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
    ...
    for (var et = A(v.store), rt = 0; et.length > rt; ) d(et[rt++]);
    c(c.S + c.F * !V, 'Symbol', {
      for: function(t) {
      ...
      j.prototype[L] || e(14)(j.prototype, L, j.prototype.valueOf),
      p(j, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
          ...
          u = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, u, c, a, f, s, l, p, h, v, y, d, g, x, m, b, S, w, _, F, E, P, O, A, M, k, I, j, T, N, R, L, D, C, B, W, U, V;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 200:
                          return (I = t.sent).initSecurityHandler(), I.lock(), console.log('Sample 3 PDF document initialized and locked'), (t.next = 206), I.getPage(1);
                        case 206:
                          return (j = t.sent), I.pagePushBack(j), I.pagePushBack(j), I.pagePushBack(j), I.pagePushBack(j), (t.next = 213), e(I, 'employee.name.first');
                        case 213:
                          return (t.next = 215), e(I, 'employee.name.last');
                        case 215:
                          return (t.next = 217), e(I, 'employee.name.check1');
                        case 217:
                          return (t.next = 219), e(I, 'submit');
                        case 219:
                          return (t.next = 221), I.saveMemoryBuffer(0);
                        case 221:
