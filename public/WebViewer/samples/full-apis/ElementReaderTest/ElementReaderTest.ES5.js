                ...
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 5:
                        return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 11), o.getPageCount();
                      case 11:
                        return t.sent, (t.next = 14), n.ElementReader.create();
                      case 14:
                        return (i = t.sent), (t.next = 17), o.getPageIterator(1);
                      case 17:
                        u = t.sent;
                      case 19:
                        return (t.next = 21), u.hasNext();
                      case 21:
                        if (!t.sent) {
                          t.next = 32;
                          break;
                        }
                        return (t.next = 24), u.current();
                      case 24:
                        return (c = t.sent), i.beginOnPage(c), (t.next = 28), r(i);
                      case 28:
                        i.end();
                      case 29:
                        u.next(), (t.next = 19);
