!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          m(r),
          i(W, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = E(r, { enumerable: _(0, !1) }))) : (i(t, R) || j(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, r)) : j(t, n, r)
        );
      },
      K = function(t, n) {
        m(t);
      ...
      X = function(t) {
        ...
        return !(this === U && i(W, t) && !i(B, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, R) && this[R][t])) || n);
      },
      J = function(t, n) {
      ...
      Q = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == R || n == a || e.push(n);
        return e;
      },
      Z = function(t) {
    ...
    G ||
      ...
      (r(45).f = X),
      (r(50).f = Z),
      u && !r(30) && f(U, 'propertyIsEnumerable', X, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
    ...
    for (var rt = F(v.store), et = 0; rt.length > et; ) d(rt[et++]);
    c(c.S + c.F * !G, 'Symbol', {
      for: function(t) {
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return console.log('Beginning Test'), (t.prev = 3), (t.next = 6), n.PDFDoc.createFromURL('../TestFiles/credit card numbers.pdf');
                          case 6:
                            return (r = t.sent).initSecurityHandler(), r.lock(), (t.next = 11), n.TextSearch.create();
                          case 11:
                            (e = t.sent), (o = n.TextSearch.Mode.e_whole_word + n.TextSearch.Mode.e_page_stop), (i = 'joHn sMiTh'), e.begin(r, i, o), (u = 0);
                          case 16:
                            return (t.next = 19), e.run();
                          case 19:
                            ...
                            return console.log(c.out_str + "'s credit card number is: "), (t.next = 26), e.getMode();
                          case 26:
                            (o = t.sent),
                          ...
                          case 38:
                            return (t.next = 40), f.hasNext();
                          case 40:
                            if (!t.sent) {
                              t.next = 49;
                              break;
                            }
                            return (t.next = 43), f.getCurrentPageNumber();
                          case 43:
                            return (a = t.sent), console.log('The current highlight is from page: ' + a), (t.next = 47), f.next();
                          case 47:
                            t.next = 38;
                            break;
                          case 49:
                            (i = '\\d{4}-\\d{6}-\\d{5}'), e.setPattern(i), ++u, (t.next = 118);
                            break;
                          case 54:
                            if (2 !== u) {
                              t.next = 66;
                            ...
                            return console.log('There is an AMEX card number: ' + c.out_str), (t.next = 58), e.getMode();
                          case 58:
                            (o = t.sent), (o += n.TextSearch.Mode.e_search_up), e.setMode(o), (i = '[A-z]++ [A-z]++'), e.setPattern(i), ++u, (t.next = 118);
                            break;
                          case 66:
                            if (3 !== u) {
                              t.next = 118;
                            ...
                            return console.log("Is the owner's name: " + c.out_str + '?'), (f = c.highlights), (t.next = 71), f.begin(r);
                          case 71:
                            return (t.next = 73), f.hasNext();
                          case 73:
                            if (!t.sent) {
                              t.next = 113;
                              break;
                            }
                            return (t.t0 = r), (t.next = 77), f.getCurrentPageNumber();
                          case 77:
                            return (t.t1 = t.sent), (t.next = 80), t.t0.getPage.call(t.t0, t.t1);
                          case 80:
                            return (s = t.sent), (t.next = 83), f.getCurrentQuads();
                          case 83:
                            (l = t.sent), (h = 0);
                          case 85:
                            if (!(h < l.length)) {
                          ...
                          case 95:
                            return (t.t4 = t.sent), (t.next = 98), t.t2.create.call(t.t2, t.t3, t.t4);
                          case 98:
                            return (b = t.sent), (t.t5 = b), (t.next = 102), n.Action.createURI(r, 'http://www.pdftron.com');
                          case 102:
                            return (t.t6 = t.sent), (t.next = 105), t.t5.setAction.call(t.t5, t.t6);
                          case 105:
                            return (t.next = 107), s.annotPushBack(b);
                          case 107:
                            ++h, (t.next = 85);
                            break;
                          case 110:
                            ...
                            break;
                          case 113:
                            return (t.next = 115), r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 115:
                            return (m = t.sent), saveBufferAsPDFDoc(m, 'credit card numbers_linked.pdf'), t.abrupt('break', 128);
                          case 118:
                            t.next = 126;
                            break;
                          case 120:
                            ...
                            console.log('page end'), (t.next = 126);
                            break;
                          case 124:
                          ...
                          case 128:
                            ...
                            break;
                          case 130:
                            (t.prev = 130), (t.t7 = t.catch(3)), console.log(t.t7);
                          case 133:
                          case 'end':
                            return t.stop();
                        }
