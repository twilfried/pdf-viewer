  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: d ? O : S('keys'), entries: M }), g)) for (b in m) b in F || i(F, b, m[b]);
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(W, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = E(r, { enumerable: _(0, !1) }))) : (i(t, R) || I(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, r)) : I(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        for (var n, r = j(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == R || n == a || e.push(n);
        return e;
      },
      Q = function(t) {
        for (var n, r = t === U, e = j(r ? B : S(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(U, n)) || o.push(W[n]);
        return o;
      };
    G ||
      (f(
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), F = a(s(u(b.index), h.length), 0), P = [], O = 1; O < b.length; O++) P.push(void 0 === (x = b[O]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [E].concat(P, F, h);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = y(E, h, F, P, M, n);
