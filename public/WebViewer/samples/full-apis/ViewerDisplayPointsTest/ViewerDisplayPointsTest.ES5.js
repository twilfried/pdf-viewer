!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== B || !i(W, n) || i(V, n))) {
          var r = A(t, n);
          return !r || !i(W, n) || (i(t, R) && t[R][n]) || (r.enumerable = !0), r;
        }
      },
      Z = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == R || n == f || e.push(n);
        return e;
      },
      Q = function(t) {
        for (var n, r = t === B, e = I(r ? V : S(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(B, n)) || o.push(W[n]);
        return o;
      };
    G ||
      (a(
        (k = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(V, r), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, _(1, r));
            };
          return u && z && Y(B, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = H),
      (r(50).f = Q),
      u && !r(30) && a(B, 'propertyIsEnumerable', H, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
    ...
    c(c.S + c.F * !G, 'Symbol', {
      ...
      k.prototype[L] || r(14)(k.prototype, L, k.prototype.valueOf),
      h(k, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
                                  ...
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (u = h.getViewerCoordinates(n, r, e)),
                                        ...
                                        (l = new f.RectangleAnnotation()).setPageNumber(n + 1),
                                  ...
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (o = h.getViewerCoordinates(n, r, e)),
                                        ...
                                        (i.x += 2),
                                        (i.y += 2),
                                        (u = new f.RectangleAnnotation()).setPageNumber(n + 1),
                                ...
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 41:
                                      return t.abrupt('break', 97);
                                    case 42:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (l = r[u]), ++u, (h = r[u]), ++u, (p = r[u]), ++u, (y = r[u]), ++u, (t.next = 56), e.mult(p, y);
                                    case 56:
                                      return (b = t.sent), (t.next = 59), v(o, b.x, b.y);
                                    case 59:
                                      return t.abrupt('break', 97);
                                    case 60:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (m = r[u]), ++u, (x = r[u]), ++u, (h = f), (p = l = a + m), (g = a), (d = y = f + x), (t.next = 76), e.mult(a, f);
                                    case 76:
                                    ...
                                    switch ((e.prev = e.next)) {
                                      case 0:
                                        return (
                                          ...
                                          (a = !0),
                                          (f = o + 1),
                                          (s = l.windowToPage(r, o)),
                                          (p = h.getPDFCoordinates(o, s.x, s.y)),
                                          (e.next = 11),
                                          i.ElementReader.create()
                                        );
                                      case 11:
                                        return (v = e.sent), (e.next = 14), i.ElementBuilder.create();
                                      case 14:
                                        return (y = e.sent), (e.next = 17), c.getPage(f);
                                      case 17:
                                        return (m = e.sent), (e.next = 20), m.getDefaultMatrix();
                                      case 20:
                                        return (x = e.sent), (e.next = 23), x.mult(p.x, p.y);
                                      case 23:
                                        if (((p = e.sent), void 0 !== (b = u[o]))) {
                                          e.next = 36;
                                          break;
                                        }
                                        return (e.next = 28), c.getPage(f);
                                      case 28:
                                        return (m = e.sent), (S = new i.OCGContext(n)), v.beginOnPage(m, S), (e.next = 33), d(v);
                                      case 33:
                                        (b = e.sent), (u[o] = b), v.end();
                                      case 36:
                                        return (e.next = 38), c.getPage(f);
                                      case 38:
                                        return (m = e.sent), (S = new i.OCGContext(n)), (e.next = 42), g(b, y, c, m, o, p, a);
                                      case 42:
                                        return (e.next = 44), i.SquareAnnot.create(c, i.Rect(10, 200, 800, 300));
                                      case 44:
                                        return (w = e.sent), (e.t0 = w), (e.next = 48), i.ColorPt.init(0, 0, 0);
                                      case 48:
                                        (e.t1 = e.sent), e.t0.setColor.call(e.t0, e.t1, 3), w.refreshAppearance(), m.annotPushBack(w), (e.next = 58);
                                        break;
                                      case 54:
                                        (e.prev = 54), (e.t2 = e.catch(1)), console.log(e.t2.stack);
                                      case 58:
                                      case 'end':
                                        return e.stop();
                                    }
