!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: g ? O : S('keys'), entries: M }), d)) for (x in m) x in P || i(P, x, m[x]);
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = u(t), a = arguments.length, f = 1, s = o.f, l = i.f; a > f; )
              for (var h, p = c(arguments[f++]), v = s ? e(p).concat(s(p)) : e(p), y = v.length, g = 0; y > g; ) l.call(p, (h = v[g++])) && (r[h] = p[h]);
            return r;
          }
        : a;
  },
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          x(r),
          i(C, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = E(r, { enumerable: _(0, !1) }))) : (i(t, R) || A(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, r)) : A(t, n, r)
        );
      },
      $ = function(t, n) {
        x(t);
        for (var r, e = d((n = S(n))), o = 0, i = e.length; i > o; ) J(t, (r = e[o++]), n[r]);
        return t;
      },
      K = function(t) {
        var n = D.call(this, (t = w(t, !0)));
        return !(this === U && i(C, t) && !i(B, t)) && (!(n || !i(this, t) || !i(C, t) || (i(this, R) && this[R][t])) || n);
      },
      X = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== U || !i(C, n) || i(B, n))) {
          var r = I(t, n);
      ...
      Q = function(t) {
        for (var n, r = t === U, e = j(r ? B : S(t)), o = [], u = 0; e.length > u; ) !i(C, (n = e[u++])) || (r && !i(U, n)) || o.push(C[n]);
        return o;
      };
    G ||
      (a(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(B, r), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, _(1, r));
            };
          return u && z && Y(U, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = K),
      (r(50).f = Q),
      u && !r(30) && a(U, 'propertyIsEnumerable', K, !0),
      (y.f = function(t) {
        return H(v(t));
      })),
    ...
    c(c.S + c.F * !G, 'Symbol', {
      ...
      N.prototype[k] || r(14)(N.prototype, k, N.prototype.valueOf),
      h(N, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), P = f(s(u(x.index), h.length), 0), F = [], O = 1; O < x.length; O++) F.push(void 0 === (b = x[O]) ? b : String(b));
            var M = x.groups;
            if (p) {
              var I = [E].concat(F, P, h);
              void 0 !== M && I.push(M);
                    ...
                    function(r) {
                      for (;;)
                        switch ((r.prev = r.next)) {
                          case 0:
                            return (r.prev = 0), console.log('Beginning Test'), (e = '../TestFiles/'), (r.next = 5), n.PDFDoc.create();
                          case 5:
                            return (o = r.sent).initSecurityHandler(), o.lock(), console.log('PDFNet and PDF document initialized and locked'), (r.next = 11), n.ElementBuilder.create();
                          case 11:
                            return (i = r.sent), (r.next = 14), n.ElementWriter.create();
                          case 14:
                            return (u = r.sent), (r.next = 17), n.Rect.init(0, 0, 612, 794);
                          case 17:
                            return (c = r.sent), (r.next = 20), o.pageCreate(c);
                          case 20:
                            return (a = r.sent), u.beginOnPage(a, n.ElementWriter.WriteMode.e_overlay), (r.next = 24), n.Image.createFromURL(o, e + 'peppers.jpg');
                          case 24:
                            return (f = r.sent), (r.next = 27), n.Matrix2D.create(200, 0, 0, 250, 50, 500);
                          case 27:
                            return (s = r.sent), (r.next = 30), n.Matrix2D.createZeroMatrix();
                          case 30:
                            return (l = r.sent), (r.next = 33), l.set(200, 0, 0, 250, 50, 500);
                          case 33:
                            return (r.next = 35), i.createImageFromMatrix(f, l);
                          case 35:
                            return (h = r.sent), u.writePlacedElement(h), (r.next = 39), n.Image.createFromURL(o, e + 'butterfly.png');
                          case 39:
                            return (f = r.sent), (r.t0 = n.Matrix2D), (r.next = 43), f.getImageWidth();
                          case 43:
                            return (r.t1 = r.sent), (r.next = 46), f.getImageHeight();
                          case 46:
                            return (r.t2 = r.sent), (r.next = 49), r.t0.create.call(r.t0, r.t1, 0, 0, r.t2, 300, 500);
                          case 49:
                            return (s = r.sent), (r.next = 52), i.createImageFromMatrix(f, s);
                          case 52:
                            return (h = r.sent), u.writePlacedElement(h), (r.next = 56), n.Image.createFromURL(o, e + 'pdfnet.gif');
                          case 56:
                            return (f = r.sent), (r.t3 = n.Matrix2D), (r.next = 60), f.getImageWidth();
                          case 60:
                            return (r.t4 = r.sent), (r.next = 63), f.getImageHeight();
                          case 63:
                            return (r.t5 = r.sent), (r.next = 66), r.t3.create.call(r.t3, r.t4, 0, 0, r.t5, 50, 350);
                          case 66:
                            return (s = r.sent), (r.next = 69), i.createImageFromMatrix(f, s);
                          case 69:
                            return (h = r.sent), u.writePlacedElement(h), (r.next = 73), n.Image.createFromURL(o, e + 'grayscale.tif');
                          case 73:
                            return (f = r.sent), (r.t6 = n.Matrix2D), (r.next = 77), f.getImageWidth();
                          case 77:
                            return (r.t7 = r.sent), (r.next = 80), f.getImageHeight();
                          case 80:
                            return (r.t8 = r.sent), (r.next = 83), r.t6.create.call(r.t6, r.t7, 0, 0, r.t8, 10, 50);
                          case 83:
                            return (s = r.sent), (r.next = 86), i.createImageFromMatrix(f, s);
                          case 86:
                            return (h = r.sent), u.writePlacedElement(h), u.end(), o.pagePushBack(a), (r.next = 92), o.pageCreate(c);
                          case 92:
                            return (a = r.sent), u.beginOnPage(a, 1, !0, !0), (r.next = 96), n.ObjSet.create();
                          case 96:
                            return (p = r.sent), (r.next = 99), p.createArray();
                          case 99:
                            return (v = r.sent), (r.next = 102), v.pushBackName('JBIG2');
                          case 102:
                            return (r.next = 104), v.pushBackName('Lossy');
                          case 104:
                            return (r.next = 106), n.Image.createFromURL(o, e + 'multipage.tif', v);
                          case 106:
                            return (f = r.sent), (r.next = 109), n.Matrix2D.create(612, 0, 0, 794, 0, 0);
                          case 109:
                            return (s = r.sent), (r.next = 112), i.createImageFromMatrix(f, s);
                          case 112:
                            return (h = r.sent), u.writePlacedElement(h), u.end(), o.pagePushBack(a), (r.next = 118), o.pageCreate(c);
                          case 118:
                            return (a = r.sent), u.beginOnPage(a, 1, !0, !0), (r.next = 122), n.Image.createFromURL(o, e + 'palm.jp2');
                          case 122:
                            return (f = r.sent), (r.t9 = n.Matrix2D), (r.next = 126), f.getImageWidth();
                          case 126:
                            return (r.t10 = r.sent), (r.next = 129), f.getImageHeight();
                          case 129:
                            return (r.t11 = r.sent), (r.next = 132), r.t9.create.call(r.t9, r.t10, 0, 0, r.t11, 96, 80);
                          case 132:
                            return (s = r.sent), (r.next = 135), i.createImageFromMatrix(f, s);
                          case 135:
                            return (h = r.sent), u.writePlacedElement(h), (r.next = 139), n.Font.create(o, n.Font.StandardType1Font.e_times_roman);
                          case 139:
                            return (y = r.sent), (r.t12 = u), (r.next = 143), i.createTextBeginWithFont(y, 32);
                          case 143:
                            return (r.t13 = r.sent), r.t12.writeElement.call(r.t12, r.t13), (r.next = 147), i.createTextRun('JPEG2000 Sample', y, 32);
                          case 147:
                            return (h = r.sent), (r.next = 150), n.Matrix2D.create(1, 0, 0, 1, 190, 30);
                          case 150:
                            return (s = r.sent), h.setTextMatrix(s), u.writeElement(h), (r.next = 155), i.createTextEnd();
                          case 155:
                            return (g = r.sent), u.writeElement(g), u.end(), o.pagePushBack(a), (r.next = 161), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 161:
                            (d = r.sent), t.saveBufferAsPDFDoc(d, 'addimage.pdf'), console.log('Done. Result saved as addimage.pdf'), (r.next = 169);
                            break;
                          case 166:
                            (r.prev = 166), (r.t14 = r.catch(0)), console.log(r.t14);
                          case 169:
                          case 'end':
                            return r.stop();
                        }
