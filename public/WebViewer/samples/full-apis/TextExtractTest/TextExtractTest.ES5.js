!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, g, d) {
      ...
      if (
        ...
        if (((x = { values: _ ? P : S('values'), keys: g ? P : S('keys'), entries: M }), d)) for (b in x) b in F || i(F, b, x[b]);
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      $ = function(t, n, e) {
        return (
          ...
          (n = w(n, !0)),
          b(e),
          i(C, n) ? (e.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (e = E(e, { enumerable: _(0, !1) }))) : (i(t, L) || k(t, L, _(1, {})), (t[L][n] = !0)), Y(t, n, e)) : k(t, n, e)
        );
      },
      H = function(t, n) {
        b(t);
        for (var e, r = d((n = S(n))), o = 0, i = r.length; i > o; ) $(t, (e = r[o++]), n[e]);
        return t;
      },
      K = function(t) {
        var n = D.call(this, (t = w(t, !0)));
        return !(this === V && i(C, t) && !i(B, t)) && (!(n || !i(this, t) || !i(C, t) || (i(this, L) && this[L][t])) || n);
      },
      J = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== V || !i(C, n) || i(B, n))) {
          var e = A(t, n);
          return !e || !i(C, n) || (i(t, L) && t[L][n]) || (e.enumerable = !0), e;
        }
      },
      Z = function(t) {
        for (var n, e = I(S(t)), r = [], o = 0; e.length > o; ) i(C, (n = e[o++])) || n == L || n == f || r.push(n);
        return r;
      },
      Q = function(t) {
        for (var n, e = t === V, r = I(e ? B : S(t)), o = [], u = 0; r.length > u; ) !i(C, (n = r[u++])) || (e && !i(V, n)) || o.push(C[n]);
        return o;
      };
    G ||
      (a(
        (j = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === V && n.call(B, e), i(this, L) && i(this[L], t) && (this[L][t] = !1), Y(this, t, _(1, e));
            };
          return u && z && Y(V, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (e(45).f = K),
      (e(50).f = Q),
      u && !e(30) && a(V, 'propertyIsEnumerable', K, !0),
      (y.f = function(t) {
        return X(v(t));
      })),
    ...
    for (var et = M(v.store), rt = 0; et.length > rt; ) g(et[rt++]);
    c(c.S + c.F * !G, 'Symbol', {
      for: function(t) {
      ...
      j.prototype[R] || e(14)(j.prototype, R, j.prototype.valueOf),
      p(j, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var m, S = '', w = 0, _ = 0; _ < x.length; _++) {
            b = x[_];
            for (var E = String(b[0]), F = f(s(u(b.index), p.length), 0), O = [], P = 1; P < b.length; P++) O.push(void 0 === (m = b[P]) ? m : String(m));
            var M = b.groups;
            if (h) {
              var A = [E].concat(O, F, p);
              void 0 !== M && A.push(M);
              var k = String(n.apply(void 0, A));
            } else k = y(E, p, F, O, M, n);
                ...
                case 0:
                  (e = (function() {
                    ...
                    (c = (function() {
                      var t = r(
                        regeneratorRuntime.mark(function t() {
                          var r, o, c, a, f, s, l, p, h, v, y, g, d, x, b, m, S, w, _, E, F, O, P, M, A, k, I, j, T, N;
                          return regeneratorRuntime.wrap(
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  case 0:
                                    return console.log('Beginning Test'), 0, (t.next = 4), n.initialize();
                                  case 4:
                                    return (
                                      (r = '../TestFiles/'),
                                      (o = 'newsletter.pdf'),
                                  ...
                                  case 15:
                                    return (t.next = 17), n.PDFDoc.createFromURL(r + o);
                                  case 17:
                                    return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 22), p.getPage(1);
                                  case 22:
                                    if ('0' !== (h = t.sent).id) {
                                      t.next = 26;
                                      break;
                                  ...
                                  case 26:
                                    return (t.next = 28), n.TextExtractor.create();
                                  case 28:
                                    return (v = t.sent), (y = new n.Rect(0, 0, 612, 794)), v.begin(h, y), (t.next = 33), v.getNumLines();
                                  case 33:
                                    if ((t.sent, !c)) {
                                      t.next = 45;
                                      break;
                                    }
                                    return (t.next = 37), v.getWordCount();
                                  case 37:
                                    return (b = t.sent), console.log('Word Count: ' + b), (t.next = 41), v.getAsText();
                                  case 41:
                                  ...
                                  case 51:
                                    ...
                                    return (t.next = 54), v.getFirstLine();
                                  case 54:
                                    d = t.sent;
                                  case 55:
                                    return (t.next = 57), d.isValid();
                                  case 57:
                                    if (!t.sent) {
                                      t.next = 78;
                                      break;
                                    }
                                    return (t.next = 60), d.getFirstWord();
                                  case 60:
                                    x = t.sent;
                                  case 61:
                                    return (t.next = 63), x.isValid();
                                  case 63:
                                    if (!t.sent) {
                                      t.next = 73;
                                      break;
                                    }
                                    return (t.next = 66), x.getString();
                                  case 66:
                                    (g = t.sent), console.log(g);
                                  case 68:
                                    return (t.next = 70), x.getNextWord();
                                  case 70:
                                    (x = t.sent), (t.next = 61);
                                    break;
                                  case 73:
                                    return (t.next = 75), d.getNextLine();
                                  case 75:
                                    (d = t.sent), (t.next = 55);
                                    break;
                                  case 78:
                                  ...
                                  case 79:
                                    ...
                                    return (w = -1), (_ = -1), (t.next = 84), n.ElementBuilder.create();
                                  case 84:
                                    return t.sent, (t.next = 87), n.ElementWriter.create();
                                  case 87:
                                    return t.sent, (t.next = 90), v.getFirstLine();
                                  case 90:
                                    d = t.sent;
                                  case 91:
                                    return (t.next = 93), d.isValid();
                                  case 93:
                                    if (!t.sent) {
                                      t.next = 183;
                                      break;
                                    }
                                    return (t.next = 96), d.getNumWords();
                                  case 96:
                                    if (((t.t0 = t.sent), 0 !== t.t0)) {
                                      t.next = 99;
                                      break;
                                    }
                                    return t.abrupt('continue', 178);
                                  case 99:
                                    return (t.next = 101), d.getFlowID();
                                  case 101:
                                    if (((t.t1 = t.sent), (t.t2 = w), t.t1 === t.t2)) {
                                      t.next = 109;
                                      break;
                                    }
                                    return -1 !== w && (-1 !== _ && ((_ = -1), console.log('</Para>')), console.log('</Flow>')), (t.next = 107), d.getFlowID();
                                  case 107:
                                    (w = t.sent), console.log('<Flow id="' + w + '">');
                                  case 109:
                                    return (t.next = 111), d.getParagraphID();
                                  case 111:
                                    if (((t.t3 = t.sent), (t.t4 = _), t.t3 === t.t4)) {
                                      t.next = 119;
                                      break;
                                    }
                                    return -1 !== _ && console.log('</Para>'), (t.next = 117), d.getParagraphID();
                                  case 117:
                                    (_ = t.sent), console.log('<Para id="' + _ + '">');
                                  case 119:
                                    return (t.next = 121), d.getBBox();
                                  case 121:
                                    return (m = t.sent), (t.next = 124), d.getStyle();
                                  case 124:
                                    return (E = t.sent), (F = '<Line box="' + m.x1 + ', ' + m.y1 + ', ' + m.x2 + ', ' + m.y1 + '">'), (t.t5 = F), (t.next = 129), u(E);
                                  case 129:
                                    return (F = t.t5 += t.sent), (t.next = 132), d.getCurrentNum();
                                  case 132:
                                    return (O = t.sent), (F += ' cur_num="' + O + '">'), console.log(F), (P = ''), (t.next = 138), d.getFirstWord();
                                  case 138:
                                    x = t.sent;
                                  case 139:
                                    return (t.next = 141), x.isValid();
                                  case 141:
                                    if (!t.sent) {
                                      t.next = 177;
                                      break;
                                    }
                                    return (t.next = 144), x.getBBox();
                                  case 144:
                                    return (S = t.sent), (t.next = 147), x.getCurrentNum();
                                  case 147:
                                    return (M = t.sent), (P += '<Word box="' + S.x1 + ', ' + S.y1 + ', ' + S.x2 + ', ' + S.y2 + '" cur_num="' + M + '"'), (t.next = 151), x.getStringLen();
                                  case 151:
                                    if (0 !== t.sent) {
                                      t.next = 154;
                                      break;
                                    }
                                    return t.abrupt('continue', 172);
                                  case 154:
                                    return (t.next = 156), x.getStyle();
                                  case 156:
                                    return (A = t.sent), (t.next = 159), A.compare(E);
                                  case 159:
                                    if (t.sent) {
                                      t.next = 165;
                                      break;
                                    }
                                    return (t.t6 = console), (t.next = 163), u(A);
                                  case 163:
                                    (t.t7 = t.sent), t.t6.log.call(t.t6, t.t7);
                                  case 165:
                                    return (t.t8 = P), (t.next = 168), x.getString();
                                  case 168:
                                    (t.t9 = t.sent), (t.t10 = '>' + t.t9), (P = t.t8 += t.t10 + '</Word>'), console.log(P);
                                  case 172:
                                    return (t.next = 174), x.getNextWord();
                                  case 174:
                                    (x = t.sent), (t.next = 139);
                                    break;
                                  case 177:
                                    console.log('</Line>');
                                  case 178:
                                    return (t.next = 180), d.getNextLine();
                                  case 180:
                                    (d = t.sent), (t.next = 91);
                                    break;
                                  case 183:
                                  ...
                                  case 184:
                                    return console.log('done'), (t.next = 187), n.endDeallocateStack();
                                  case 187:
                                    t.next = 194;
                                    break;
                                  case 189:
                                    (t.prev = 189), (t.t11 = t.catch(12)), console.log(t.t11), console.log(t.t11.stack), 1;
                                  case 194:
                                    if (!l) {
                                      t.next = 271;
                                      break;
                                    }
                                    return 0, (t.prev = 196), (t.next = 199), n.startDeallocateStack();
                                  case 199:
                                    return (t.next = 201), n.PDFDoc.createFromURL(r + o);
                                  case 201:
                                    return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 206), n.ElementReader.create();
                                  case 206:
                                    return (k = t.sent), (t.next = 209), p.getPageIterator(1);
                                  case 209:
                                    I = t.sent;
                                  case 211:
                                    return (t.next = 213), I.hasNext();
                                  case 213:
                                    if (!t.sent) {
                                      t.next = 224;
                                      break;
                                    }
                                    return (t.next = 216), I.current();
                                  case 216:
                                    return (j = t.sent), k.beginOnPage(j), (t.next = 220), e(k);
                                  case 220:
                                    k.end();
                                  case 221:
                                    I.next(), (t.next = 211);
                                  ...
                                  case 229:
                                    return (t.next = 231), t.sent.current();
                                  case 231:
                                    return (T = t.sent), (t.t12 = i), (t.t13 = T), (t.next = 236), n.Rect.init(27, 392, 563, 534);
                                  case 236:
                                    return (t.t14 = t.sent), (t.t15 = k), (t.next = 240), (0, t.t12)(t.t13, t.t14, t.t15);
                                  case 240:
                                    return (N = t.sent), console.log('Field 1: ' + N), (t.t16 = i), (t.t17 = T), (t.next = 246), n.Rect.init(28, 551, 106, 623);
                                  case 246:
                                    return (t.t18 = t.sent), (t.t19 = k), (t.next = 250), (0, t.t16)(t.t17, t.t18, t.t19);
                                  case 250:
                                    return (N = t.sent), console.log('Field 2: ' + N), (t.t20 = i), (t.t21 = T), (t.next = 256), n.Rect.init(208, 550, 387, 621);
                                  case 256:
                                    return (t.t22 = t.sent), (t.t23 = k), (t.next = 260), (0, t.t20)(t.t21, t.t22, t.t23);
                                  case 260:
                                    return (N = t.sent), console.log('Field 3: ' + N), console.log('Done'), (t.next = 265), n.endDeallocateStack();
                                  case 265:
                                    t.next = 271;
                                    break;
                                  case 267:
                                    (t.prev = 267), (t.t24 = t.catch(196)), console.log(t.t24.stack), 1;
                                  case 271:
                                  case 'end':
                                    return t.stop();
                                }
