!(function(t) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(W, n) ? (r.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (r = F(r, { enumerable: _(0, !1) }))) : (i(t, L) || j(t, L, _(1, {})), (t[L][n] = !0)), H(t, n, r)) : j(t, n, r)
        );
      },
      $ = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == L || n == f || e.push(n);
        return e;
      },
      Q = function(t) {
      ...
      (a(
        (N = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(B, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), H(this, t, _(1, r));
            };
          return u && z && H(U, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                F = a(m, h ? p : p.slice(S));
              if (null === F || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === x) S = u(p, S, g);
              else {
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runDigitalSignatureTest = function() {
        var n = t.PDFNet,
          r = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var r, e, o, i, u, c, a, f, s, l, p, h, v, y, g, d;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 56:
                          return (g = t.sent).putRect('BBox', 0, 0, h, v), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), s.begin(i), (t.next = 63), l.createFormFromStream(g);
                        case 63:
                          return (y = t.sent), s.writePlacedElement(y), (t.next = 67), s.end();
                        case 67:
                          return (g = t.sent).putRect('BBox', 0, 0, h, v), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), (t.next = 73), a.setAppearance(g);
                        case 73:
                          return (t.next = 75), a.refreshAppearance();
                        case 75:
                          return (t.next = 77), i.saveMemoryBuffer(0);
                        case 77:
                          (d = t.sent), saveBufferAsPDFDoc(d, 'signed_doc.pdf'), console.log('Finished signing PDF document'), (t.next = 85);
                          break;
                        case 82:
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 67:
                          (g = t.sent), saveBufferAsPDFDoc(g, 'newsletter_certified.pdf'), console.log('Finished certifying PDF document.'), (t.next = 75);
                          break;
                        case 72:
