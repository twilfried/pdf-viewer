!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports =
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = c(t), a = arguments.length, s = 1, f = o.f, l = i.f; a > s; )
              for (var p, h = u(arguments[s++]), v = f ? r(h).concat(f(h)) : r(h), y = v.length, d = 0; y > d; ) l.call(h, (p = v[d++])) && (e[p] = h[p]);
            return e;
          }
        : a;
  },
  ...
  function(t, n, e) {
    ...
    t.exports = function(t) {
      return function(n) {
        for (var e, c = o(n), u = r(c), a = u.length, s = 0, f = []; a > s; ) i.call(c, (e = u[s++])) && f.push(t ? [e, c[e]] : c[e]);
        return f;
      };
    };
  },
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      q =
        ...
        f(function() {
          ...
          : k,
      Y = function(t) {
        var n = (D[t] = A(I.prototype));
        return (n._k = t), n;
      },
      H =
        U && 'symbol' == r(I.iterator)
          ? function(t) {
              return 'symbol' == r(t);
            }
          : function(t) {
      ...
      $ = function(t, n, e) {
        return (
          ...
          (n = w(n, !0)),
          S(e),
          i(D, n) ? (e.enumerable ? (i(t, T) && t[T][n] && (t[T][n] = !1), (e = A(e, { enumerable: P(0, !1) }))) : (i(t, T) || k(t, T, P(1, {})), (t[T][n] = !0)), q(t, n, e)) : k(t, n, e)
        );
      },
      K = function(t, n) {
        S(t);
        for (var e, r = g((n = m(n))), o = 0, i = r.length; i > o; ) $(t, (e = r[o++]), n[e]);
        return t;
      },
      X = function(t) {
        var n = B.call(this, (t = w(t, !0)));
        return !(this === V && i(D, t) && !i(W, t)) && (!(n || !i(this, t) || !i(D, t) || (i(this, T) && this[T][t])) || n);
      },
      J = function(t, n) {
        if (((t = m(t)), (n = w(n, !0)), t !== V || !i(D, n) || i(W, n))) {
          var e = F(t, n);
          return !e || !i(D, n) || (i(t, T) && t[T][n]) || (e.enumerable = !0), e;
        }
      },
      Q = function(t) {
        for (var n, e = R(m(t)), r = [], o = 0; e.length > o; ) i(D, (n = e[o++])) || n == T || n == s || r.push(n);
        return r;
      },
      Z = function(t) {
        for (var n, e = t === V, r = R(e ? W : m(t)), o = [], c = 0; r.length > c; ) !i(D, (n = r[c++])) || (e && !i(V, n)) || o.push(D[n]);
        return o;
      };
    U ||
      (a(
        (I = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === V && n.call(W, e), i(this, T) && i(this[T], t) && (this[T][t] = !1), q(this, t, P(1, e));
            };
          return c && z && q(V, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (e(45).f = X),
      (e(50).f = Z),
      c && !e(30) && a(V, 'propertyIsEnumerable', X, !0),
      (y.f = function(t) {
        return Y(v(t));
      })),
    ...
    for (var et = O(v.store), rt = 0; et.length > rt; ) d(et[rt++]);
    u(u.S + u.F * !U, 'Symbol', {
      for: function(t) {
      ...
      I.prototype[j] || e(14)(I.prototype, j, I.prototype.valueOf),
      p(I, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
                            ...
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  ...
                                  case 3:
                                    return console.log('running LowLevelAPI'), (t.next = 6), n.getPageIterator(1);
                                  case 6:
                                    return (r = t.sent), (t.next = 9), r.current();
                                  case 9:
                                    return (o = t.sent), (t.next = 12), o.getAnnots();
                                  case 12:
                                    if (null != (i = t.sent)) {
                                      t.next = 22;
                                      break;
                                    }
                                    return (t.next = 16), n.createIndirectArray();
                                  case 16:
                                    return (i = t.sent), (t.next = 19), o.getSDFObj();
                                  case 19:
                                    return (c = t.sent), (t.next = 22), c.put('Annots', i);
                                  case 22:
                                    return (t.next = 24), n.createIndirectDict();
                                  case 24:
                                    return (u = t.sent), (t.next = 27), u.putName('Subtype', 'Text');
                                  case 27:
                                    return (t.next = 29), u.putBool('Open', !0);
                                  case 29:
                                    return (t.next = 31), u.putString('Contents', 'The quick brown fox ate the lazy mouse.');
                                  case 31:
                                    return (t.next = 33), u.putRect('Rect', 266, 116, 430, 204);
                                  case 33:
                                    return (t.next = 35), i.pushBack(u);
                                  case 35:
                                    return (t.next = 37), n.createIndirectDict();
                                  case 37:
                                    return (a = t.sent), (t.next = 40), a.putName('Subtype', 'Link');
                                  case 40:
                                    return (t.t0 = e.Destination), (t.next = 43), n.getPage(2);
                                  case 43:
                                    return (t.t1 = t.sent), (t.next = 46), t.t0.createFit.call(t.t0, t.t1);
                                  case 46:
                                    return (s = t.sent), (t.t2 = a), (t.next = 50), s.getSDFObj();
                                  case 50:
                                    return (t.t3 = t.sent), (t.next = 53), t.t2.put.call(t.t2, 'Dest', t.t3);
                                  case 53:
                                    return (t.next = 55), a.putRect('Rect', 85, 705, 503, 661);
                                  case 55:
                                    return (t.next = 57), i.pushBack(a);
                                  case 57:
                                    return (t.next = 59), n.createIndirectDict();
                                  case 59:
                                    return (f = t.sent), (t.next = 62), f.putName('Subtype', 'Link');
                                  case 62:
                                    return (t.t4 = e.Destination), (t.next = 65), n.getPage(3);
                                  case 65:
                                    return (t.t5 = t.sent), (t.next = 68), t.t4.createFit.call(t.t4, t.t5);
                                  case 68:
                                    return (l = t.sent), (t.t6 = f), (t.next = 72), l.getSDFObj();
                                  case 72:
                                    return (t.t7 = t.sent), (t.next = 75), t.t6.put.call(t.t6, 'Dest', t.t7);
                                  case 75:
                                    return (t.next = 77), f.putRect('Rect', 85, 638, 503, 594);
                                  case 77:
                                    return (t.next = 79), i.pushBack(f);
                                  case 79:
                                    return (t.next = 81), n.getPage(10);
                                  case 81:
                                    return (p = t.sent), (t.next = 84), e.Destination.createXYZ(p, 100, 722, 10);
                                  case 84:
                                    return (h = t.sent), (t.t8 = f), (t.next = 88), h.getSDFObj();
                                  case 88:
                                    return (t.t9 = t.sent), (t.next = 91), t.t8.put.call(t.t8, 'Dest', t.t9);
                                  case 91:
                                    return (t.next = 93), n.createIndirectDict();
                                  case 93:
                                    return (v = t.sent), (t.next = 96), v.putName('Subtype', 'Link');
                                  case 96:
                                    return (t.next = 98), v.putRect('Rect', 85, 570, 503, 524);
                                  case 98:
                                    return (t.next = 100), v.putDict('A');
                                  case 100:
                                    return (y = t.sent), (t.next = 103), y.putName('S', 'URI');
                                  case 103:
                                    return (t.next = 105), y.putString('URI', 'http://www.pdftron.com');
                                  case 105:
                                    return (t.next = 107), i.pushBack(v);
                                  case 107:
                                    return console.log('AnnotationLowLevel Done.'), (t.next = 110), e.endDeallocateStack();
                                  case 110:
                                    t.next = 115;
                                    break;
                                  case 112:
                                    (t.prev = 112), (t.t10 = t.catch(0)), console.log(t.t10);
                                  case 115:
                                  case 'end':
                                    return t.stop();
                                }
                          ...
                          return regeneratorRuntime.wrap(function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                ...
                                case 42:
                                  return (t.t0 = t.sent), (h = 'Annot Type: ' + t.t0), (t.next = 46), s.getRect();
                                case 46:
                                  return (v = t.sent), (h += ';  Position: ' + v.x1 + ', ' + v.y1 + ', ' + v.x2 + ', ' + v.y2), console.log(h), (t.next = 51), s.getType();
                                case 51:
                                  (y = t.sent), (t.t1 = y), (t.next = t.t1 === e.Annot.Type.e_Link ? 55 : t.t1 === e.Annot.Type.e_Widget ? 107 : t.t1 === e.Annot.Type.e_FileAttachment ? 108 : 109);
                                  break;
                                case 55:
                                  return (t.next = 57), e.LinkAnnot.createFromAnnot(s);
                                case 57:
                                  return (d = t.sent), (t.next = 60), d.getAction();
                                case 60:
                                  return (g = t.sent), (t.next = 63), g.isValid();
                                case 63:
                                  if (t.sent) {
                                    t.next = 65;
                                    break;
                                  ...
                                  return t.abrupt('continue', 112);
                                case 65:
                                  return (t.next = 67), g.getType();
                                case 67:
                                  if (((t.t2 = t.sent), (t.t3 = e.Action.Type.e_GoTo), t.t2 !== t.t3)) {
                                    t.next = 87;
                                    break;
                                  }
                                  return (t.next = 72), g.getDest();
                                case 72:
                                  return (x = t.sent), (t.next = 75), x.isValid();
                                case 75:
                                  if (t.sent) {
                                    t.next = 79;
                                    break;
                                  }
                                  console.log('  Destination is not valid'), (t.next = 85);
                                  break;
                                case 79:
                                  return (t.next = 81), x.getPage();
                                case 81:
                                  return (t.next = 83), t.sent.getIndex();
                                case 83:
                                ...
                                case 85:
                                  ...
                                  break;
                                case 87:
                                  return (t.next = 89), g.getType();
                                case 89:
                                  if (((t.t4 = t.sent), (t.t5 = e.Action.Type.e_URI), t.t4 !== t.t5)) {
                                    t.next = 106;
                                    break;
                                  }
                                  return (t.next = 94), g.getSDFObj();
                                case 94:
                                  return (b = t.sent), (t.next = 97), b.get('URI');
                                case 97:
                                  return (m = t.sent), (t.next = 100), m.value();
                                case 100:
                                  return (w = t.sent), (t.next = 103), w.getAsPDFText();
                                case 103:
                                ...
                                case 108:
                                case 109:
                                  return t.abrupt('break', 110);
                                case 110:
                                  return (t.next = 112), l.destroy();
                                case 112:
                                  ++a, (t.next = 23);
                                  break;
                                case 115:
                                  return (t.next = 117), i.next();
                                case 117:
                                  t.next = 11;
                                  break;
                                case 119:
                                  return (t.next = 121), n.getPage(1);
                                case 121:
                                  return (r = t.sent), (t.next = 124), e.Action.createURI(n, 'http://www.pdftron.com');
                                case 124:
                                  return (A = t.sent), (_ = new e.Rect(85, 570, 503, 524)), (t.next = 128), e.LinkAnnot.create(n, _);
                                case 128:
                                  return (E = t.sent), (t.next = 131), E.setAction(A);
                                case 131:
                                  return (t.next = 133), r.annotPushBack(E);
                                case 133:
                                  return (t.next = 135), n.getPage(3);
                                case 135:
                                  return (C = t.sent), (t.t6 = e.Action), (t.next = 139), e.Destination.createFitH(C, 0);
                                case 139:
                                  return (t.t7 = t.sent), (t.next = 142), t.t6.createGoto.call(t.t6, t.t7);
                                case 142:
                                  return (O = t.sent), (t.next = 145), e.LinkAnnot.create(n, new e.Rect(85, 458, 503, 502));
                                case 145:
                                  return (F = t.sent), (t.next = 148), F.setAction(O);
                                case 148:
                                  return (t.next = 150), e.AnnotBorderStyle.create(e.AnnotBorderStyle.Style.e_solid, 3, 0, 0);
                                case 150:
                                  return (k = t.sent), F.setBorderStyle(k, !1), (t.next = 154), e.ColorPt.init(0, 0, 1, 0);
                                case 154:
                                  return (R = t.sent), (t.next = 157), F.setColorDefault(R);
                                case 157:
                                  return (t.next = 159), r.annotPushBack(F);
                                case 159:
                                  return (t.next = 161), e.RubberStampAnnot.create(n, new e.Rect(30, 30, 300, 200));
                                case 161:
                                  return (I = t.sent), (t.next = 164), I.setIconName('Draft');
                                case 164:
                                  return (t.next = 166), r.annotPushBack(I);
                                case 166:
                                  return (t.next = 168), e.InkAnnot.create(n, new e.Rect(110, 10, 300, 200));
                                case 168:
                                  return (L = t.sent), (M = new e.Point(110, 10)), (t.next = 172), L.setPoint(0, 0, M);
                                case 172:
                                  return (M.x = 150), (M.y = 50), (t.next = 176), L.setPoint(0, 1, M);
                                case 176:
                                  return (M.x = 190), (M.y = 60), (t.next = 180), L.setPoint(0, 2, M);
                                case 180:
                                  return (M.x = 180), (M.y = 90), (t.next = 184), L.setPoint(1, 0, M);
                                case 184:
                                  return (M.x = 190), (M.y = 95), (t.next = 188), L.setPoint(1, 1, M);
                                case 188:
                                  return (M.x = 200), (M.y = 100), (t.next = 192), L.setPoint(1, 2, M);
                                case 192:
                                  return (M.x = 166), (M.y = 86), (t.next = 196), L.setPoint(2, 0, M);
                                case 196:
                                  return (M.x = 196), (M.y = 96), (t.next = 200), L.setPoint(2, 1, M);
                                case 200:
                                  return (M.x = 221), (M.y = 121), (t.next = 204), L.setPoint(2, 2, M);
                                case 204:
                                  return (M.x = 288), (M.y = 188), (t.next = 208), L.setPoint(2, 3, M);
                                case 208:
                                  return (t.next = 210), e.ColorPt.init(0, 1, 1, 0);
                                case 210:
                                  return (T = t.sent), (t.next = 213), L.setColor(T, 3);
                                case 213:
                                  return r.annotPushBack(L), (t.next = 216), e.endDeallocateStack();
                                case 216:
                                case 'end':
                                  return t.stop();
                              }
                          ...
                          return regeneratorRuntime.wrap(function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                ...
                                case 86:
                                  return (t.next = 88), o.reset(new e.GState('0'));
                                case 88:
                                ...
                                case 112:
                                  return (x = new Float64Array([2, 2])), (t.next = 115), e.AnnotBorderStyle.createWithDashPattern(e.AnnotBorderStyle.Style.e_dashed, 2, 0, 0, x);
                                case 115:
                                ...
                                case 478:
                                  return (
                                    (H = t.sent).setQuadPoint(0, e.QuadPoint(122, 455, 240, 545, 230, 595, 101, 500)),
                                    H.refreshAppearance(),
                                    z.annotPushBack(H),
                                    (t.next = 484),
                                ...
                                switch ((t.prev = t.next)) {
                                  case 0:
                                    return (
                                      ...
                                      '../TestFiles/',
                                      (t.next = 6),
                                      e.PDFDoc.createFromURL('../TestFiles/numbered.pdf')
                                    );
                                  case 6:
                                    return (r = t.sent).initSecurityHandler(), r.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 12), o(r);
                                  case 12:
                                    return (t.next = 14), r.saveMemoryBuffer(e.SDFDoc.SaveOptions.e_linearized);
                                  case 14:
                                    return (u = t.sent), saveBufferAsPDFDoc(u, 'annotation_testLowLevel.pdf'), (t.next = 18), r.getPage(1);
                                  case 18:
                                    return t.sent, (t.next = 21), i(r);
                                  case 21:
                                    return (t.next = 23), r.saveMemoryBuffer(e.SDFDoc.SaveOptions.e_linearized);
                                  case 23:
                                    return (a = t.sent), saveBufferAsPDFDoc(a, 'annotation_testHighLevel.pdf'), (t.next = 27), e.PDFDoc.create();
                                  case 27:
                                    return (s = t.sent).lock(), (t.next = 31), c(s);
                                  case 31:
                                    return (t.next = 33), s.saveMemoryBuffer(e.SDFDoc.SaveOptions.e_linearized);
                                  case 33:
                                    return (f = t.sent), saveBufferAsPDFDoc(f, 'new_annot_test_api.pdf'), console.log('Done.'), t.abrupt('return', n);
                                  case 39:
