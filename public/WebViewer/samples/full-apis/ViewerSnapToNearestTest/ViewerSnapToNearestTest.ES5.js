!(function(t) {
  ...
  function(t, n, r) {
    ...
    G ||
      ...
      (r(45).f = X),
      (r(50).f = Q),
      u && !r(30) && f(B, 'propertyIsEnumerable', X, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
    ...
    window,
      (e = function(t) {
        var n = readerControl.docViewer.getDisplayModeManager().getDisplayMode(),
          ...
          o = null !== e.first ? e.first : readerControl.docViewer.getCurrentPage() - 1;
        return { point: n.windowToPage(r, o), pageNumber: o + 1 };
      }),
          ...
          panel: {
            ...
            render: function() {
              var t = readerControl.docViewer.SnapMode,
                n = t.e_DefaultSnapMode,
                e = t.e_PointOnLine,
                o = t.e_LineMidpoint,
                i = t.e_LineIntersection,
                u = t.e_PathEndpoint,
