!(function(t) {
    ...
    if (r(9)) {
      var o = r(30),
        ...
        kt = {
          ...
          filter: function(t) {
            return Ot(this, J(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Lt = function(t, n) {
          return Ot(this, ht.call(Ft(this), t, n));
        },
        Ct = function(t) {
          Ft(this);
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new q(i) }); s < c; ) E(t, s++);
              })),
              (_ = v.prototype = P(Vt)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? A : S('values'), keys: g ? A : S('keys'), entries: O }), d)) for (b in m) b in P || i(P, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[N], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (O || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== F.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
      ...
      R = function(t) {
        d.call(a, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                O ? E.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = O || k(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(W, n) ? (r.enumerable ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = E(r, { enumerable: _(0, !1) }))) : (i(t, k) || j(t, k, _(1, {})), (t[k][n] = !0)), Y(t, n, r)) : j(t, n, r)
        );
      },
      q = function(t, n) {
        b(t);
      ...
      $ = function(t) {
        ...
        return !(this === U && i(W, t) && !i(B, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, k) && this[k][t])) || n);
      },
      J = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== U || !i(W, n) || i(B, n))) {
          var r = M(t, n);
          return !r || !i(W, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0), r;
        }
      },
      Z = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == k || n == f || e.push(n);
        return e;
      },
      Q = function(t) {
        for (var n, r = t === U, e = I(r ? B : S(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(U, n)) || o.push(W[n]);
        return o;
      };
    V ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(B, r), i(this, k) && i(this[k], t) && (this[k][t] = !1), Y(this, t, _(1, r));
            };
      ...
      (r(45).f = $),
      (r(50).f = Q),
      u && !r(30) && a(U, 'propertyIsEnumerable', $, !0),
      (y.f = function(t) {
        return H(v(t));
      })),
    ...
    for (var rt = O(v.store), et = 0; rt.length > et; ) g(rt[et++]);
    c(c.S + c.F * !V, 'Symbol', {
      for: function(t) {
      ...
      T.prototype[L] || r(14)(T.prototype, L, T.prototype.valueOf),
      h(T, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), h.length), 0), F = [], A = 1; A < b.length; A++) F.push(void 0 === (x = b[A]) ? x : String(x));
            var O = b.groups;
            if (p) {
              var M = [E].concat(F, P, h);
              void 0 !== O && M.push(O);
              var j = String(n.apply(void 0, M));
            } else j = y(E, h, P, F, O, n);
  ...
  function(t, n) {
    ...
    !(function(t) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return console.log('Loading document...'), (t.next = 3), n.initialize();
                    case 3:
                      return (t.next = 5), n.PDFDoc.create();
                    case 5:
                      return (r = t.sent).initSecurityHandler(), r.lock(), (t.next = 10), n.Rect.init(0, 0, 612, 794);
                    case 10:
                      return (e = t.sent), (t.next = 13), r.pageCreate(e);
                    case 13:
                      return (o = t.sent), r.pagePushBack(o), (t.next = 17), r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                    case 17:
                      (i = t.sent), (u = new Blob([i], { type: 'application/pdf' })), readerControl.loadDocument(u, { filename: 'myfile.pdf' });
                    case 20:
                    case 'end':
                      return t.stop();
                  }
            ...
            regeneratorRuntime.mark(function t() {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (i = readerControl.docViewer), (u = i.getAnnotationManager()), (c = r(u.getAnnotationsList())), (a = i.getDocument()), (t.next = 6), n.initialize();
                    case 6:
                      return (t.next = 8), a.getPDFDoc();
                    case 8:
                      return (
                        (f = t.sent),
                        (t.next = 11),
                                    ...
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          ...
                                          if ((console.log(r.custom), 'TEXT' !== r.custom.type)) {
                                            t.next = 8;
                                            break;
                                          }
                                          return (t.next = 5), f.fieldCreateFromStrings(r.getContents() + Date.now() + e, n.Field.Type.e_text, r.custom.value, '');
                                        case 5:
                                          (o = t.sent), (t.next = 22);
                                          break;
                                        case 8:
                                          if ('SIGNATURE' !== r.custom.type) {
                                            t.next = 14;
                                            break;
                                          }
                                          return (t.next = 11), f.fieldCreateFromStrings(r.getContents() + Date.now() + e, n.Field.Type.e_signature, '', '');
                                        case 11:
                                          (o = t.sent), (t.next = 22);
                                          break;
                                        case 14:
                                          if ('CHECK' !== r.custom.type) {
                                            t.next = 20;
                                            break;
                                          }
                                          return (t.next = 17), f.fieldCreateFromStrings(r.getContents() + Date.now() + e, n.Field.Type.e_check, '', '');
                                        case 17:
                                          (o = t.sent), (t.next = 22);
                                          break;
                                        case 20:
                                          return u.deleteAnnotation(r, !1, !0), t.abrupt('return');
                                        case 22:
                                          !0 === r.custom.flag && o.setFlag(n.Field.Flag.e_read_only, !0), (t.next = 27);
                                          break;
                                        case 25:
                                          return u.deleteAnnotation(r, !1, !0), t.abrupt('return');
                                        case 27:
                                          return (t.next = 29), r.getRect();
                                        case 29:
                                          return (
                                            (i = t.sent),
                                            (c = a.getPDFCoordinates(r.getPageNumber() - 1, i.x1, i.y1)),
                                            (s = a.getPDFCoordinates(r.getPageNumber() - 1, i.x2, i.y2)),
                                            (l = r.getPageNumber()),
                                            (t.t0 = n.WidgetAnnot),
                                            (t.t1 = f),
                                            (t.next = 37),
                                            n.Rect.init(c.x, c.y, s.x, s.y)
                                          );
                                        case 37:
                                          return (t.t2 = t.sent), (t.t3 = o), (t.next = 41), t.t0.create.call(t.t0, t.t1, t.t2, t.t3);
                                        case 41:
                                          return (
                                            (h = t.sent),
                                            u.deleteAnnotation(r, !1, !0),
                                            (Annotations.WidgetAnnotation.getCustomStyles = function(t) {
                                              return t instanceof Annotations.TextWidgetAnnotation
                                                ? { 'background-color': '#a5c7ff', color: 'white', 'font-size': '20px' }
                                                : t instanceof Annotations.SignatureWidgetAnnotation
                                                ? { border: '1px solid #a5c7ff' }
                                                : void 0;
                                            }),
                                            Annotations.WidgetAnnotation.getCustomStyles(h),
                                            (t.next = 47),
                                            f.getPage(l)
                                          );
                                        case 47:
                                          return (p = t.sent), (t.next = 50), p.annotPushBack(h);
                                        case 50:
                                          return (t.next = 52), f.refreshFieldAppearances();
                                        case 52:
                                        case 'end':
                                          return t.stop();
                                      }
                    ...
                    case 11:
                      return (t.next = 13), f.fdfExtract(n.PDFDoc.ExtractFlag.e_both);
                    case 13:
                      return (s = t.sent), (t.next = 16), s.saveAsXFDFAsString();
                    case 16:
                      return (l = t.sent), (t.next = 19), u.importAnnotations(l);
                    case 19:
                      i.refreshAll(), i.updateView(), i.getDocument().refreshTextData(), (e = {});
                    case 23:
                    case 'end':
                      return t.stop();
                  }
      ...
      (t.addFormFieldAnnot = function(t, n, r, o) {
        var i = readerControl.docViewer,
          u = i.getAnnotationManager(),
          c = i.getZoom(),
          a = i.getDocument(),
          f = i.getDisplayModeManager().getDisplayMode(),
          s = f.getSelectedPages(e, e);
        if (!e.x || null != s.first) {
          var l = null !== s.first ? s.first : i.getCurrentPage() - 1,
            h = a.getPageInfo(l),
            p = f.windowToPage(e, l),
            v = new Annotations.FreeTextAnnotation();
          v.PageNumber = l + 1;
          var y = 90 * i.getCompleteRotation(l + 1);
          (v.Rotation = y),
            'CHECK' === t ? ((v.Width = 50 / c), (v.Height = 50 / c)) : 270 === y || 90 === y ? ((v.Width = 50 / c), (v.Height = 250 / c)) : ((v.Width = 250 / c), (v.Height = 50 / c)),
            (v.X = (p.x || h.width / 2) - v.Width / 2),
            (v.Y = (p.y || h.height / 2) - v.Height / 2),
            v.setPadding(new Annotations.Rect(0, 0, 0, 0)),
            (v.custom = { type: t, value: r, flag: o }),
            v.setContents(n + '_' + t),
            (v.FontSize = 10 / c + 'px'),
            (v.FillColor = new Annotations.Color(211, 211, 211, 0.5)),
            (v.TextColor = new Annotations.Color(0, 165, 228)),
            (v.StrokeThickness = 1),
            (v.StrokeColor = new Annotations.Color(0, 165, 228)),
            (v.TextAlign = 'center'),
        ...
        (t.convertAnnotToFormField = u),
        (t.createNewPDF = i),
        (t.setDropPoint = function(t) {
          e = { x: t.x, y: t.y };
        });
    })(window);
  },
