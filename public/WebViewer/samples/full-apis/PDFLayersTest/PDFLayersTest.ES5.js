!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), x = o(d), m = r(c, v, 3), b = u(x.length), S = 0, w = e ? p(n, b) : a ? p(n, 0) : void 0; b > S; S++)
          if ((h || S in x) && ((g = m((y = x[S]), S, d)), t))
            if (e) w[S] = g;
            else if (g)
              switch (t) {
                case 3:
        ...
        (t.exports = function(t, n, e, r) {
          ...
          m
            ...
            : (u(function() {
              ...
              J(x !== Function.prototype ? F(y).concat(F(x)) : F(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, y, g, d) {
      ...
      } else (m = y.getConstructor(n, t, g, b)), u(m.prototype, e), (c.NEED = !0);
      return p(m, t), (w[t] = m), o(o.G + o.W + o.F * (m != x), w), d || y.setStrong(m, t, g), m;
    };
  },
  function(t, n, e) {
    for (
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, g, d) {
      ...
      if (
        ...
        if (((x = { values: _ ? F : S('values'), keys: g ? F : S('keys'), entries: M }), d)) for (m in x) m in O || i(O, m, x[m]);
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = u(t), a = arguments.length, f = 1, s = o.f, l = i.f; a > f; )
              for (var h, p = c(arguments[f++]), v = s ? r(p).concat(s(p)) : r(p), y = v.length, g = 0; y > g; ) l.call(p, (h = v[g++])) && (e[h] = p[h]);
            return e;
          }
        : a;
  },
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      K = function(t, n, e) {
        return (
          ...
          (n = w(n, !0)),
          m(e),
          i(B, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = E(e, { enumerable: _(0, !1) }))) : (i(t, R) || j(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, e)) : j(t, n, e)
        );
      },
      $ = function(t, n) {
        m(t);
      ...
      J = function(t) {
        ...
        return !(this === G && i(B, t) && !i(W, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, R) && this[R][t])) || n);
      },
      X = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== G || !i(B, n) || i(W, n))) {
          var e = A(t, n);
          return !e || !i(B, n) || (i(t, R) && t[R][n]) || (e.enumerable = !0), e;
        }
      },
      Z = function(t) {
        for (var n, e = I(S(t)), r = [], o = 0; e.length > o; ) i(B, (n = e[o++])) || n == R || n == f || r.push(n);
        return r;
      },
      Q = function(t) {
        for (var n, e = t === G, r = I(e ? W : S(t)), o = [], u = 0; r.length > u; ) !i(B, (n = r[u++])) || (e && !i(G, n)) || o.push(B[n]);
        return o;
      };
    V ||
      (a(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === G && n.call(W, e), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, _(1, e));
            };
    ...
    c(c.S + c.F * !V, 'Symbol', {
      ...
      N.prototype[L] || e(14)(N.prototype, L, N.prototype.valueOf),
      h(N, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            x = s(h);
          if ((g && (y = r(y, v > 2 ? arguments[2] : void 0, 2)), null == x || (p == Array && c(x)))) for (e = new p((n = a(h.length))); n > d; d++) f(e, d, g ? y(h[d], d) : h[d]);
          else for (l = x.call(h), e = new p(); !(o = l.next()).done; d++) f(e, d, g ? u(l, y, [o.value, d], !0) : o.value);
          return (e.length = d), e;
        },
      }
    );
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = a(x, p ? h : h.slice(S));
              if (null === E || (_ = l(c(x.lastIndex + (p ? 0 : S)), h.length)) === b) S = u(h, S, g);
              else {
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      m = (t.exports = e(58)('WeakMap', d, x, f, !0, !0));
    h &&
      p &&
  ...
  function(t, n, e) {
    for (
      ...
      var g,
        ...
        m = u[d],
        b = m && m.prototype;
      if (b && (b[s] || c(b, s, h), b[l] || c(b, l, d), (a[d] = h), x)) for (g in r) b[g] || i(b, g, r[g], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
      ...
      var e = (function(t) {
        ...
        var w = (x.prototype = g.prototype = Object.create(m));
        function _(t) {
          ...
          c = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, c, a, f, s, l, h, p, v, y, g, d, x, m, b, S, w, _, E, O, P, F, M, A, j;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 27:
                          return (h = t.sent).beginOnPage(s), (t.t0 = r), (t.t1 = o), (t.next = 33), c.getSDFObj();
                        case 33:
                          return (t.t2 = t.sent), (t.next = 36), (0, t.t0)(t.t1, t.t2);
                        case 36:
                          return (p = t.sent), (t.next = 39), l.createFormFromStream(p);
                        case 39:
                          return (v = t.sent), h.writeElement(v), (t.t3 = i), (t.t4 = o), (t.next = 45), f.getSDFObj();
                        case 45:
                          return (t.t5 = t.sent), (t.next = 48), (0, t.t3)(t.t4, t.t5);
                        case 48:
                          return (y = t.sent), (t.next = 51), l.createFormFromStream(y);
                        case 51:
                          (v = t.sent), h.writeElement(v), (t.next = 87);
                          break;
                        case 58:
                        ...
                        case 98:
                          v = t.sent;
                        case 99:
                          return h.writeElement(v), (t.t22 = l), (t.next = 103), s.getPageWidth();
                        case 103:
                        ...
                        case 114:
                          return t.sent.setLineWidth(40), h.writeElement(v), h.end(), o.pagePushBack(s), (t.next = 121), o.getViewPrefs();
                        case 121:
                        ...
                        case 168:
                          ...
                          return (t.t26 = n.OCG), (t.next = 172), E.getAt(O);
                        case 172:
