    ...
    if (webViewerServer === 'n' && xod === 'n') {
      ...
      if (office === 'n') {
        ...
        filesToRelocate.push(
          ...
          [path.resolve(__dirname, '../lib/core/office/WebOfficeWorker.br.js.mem'), `${resourceDir}/officeAsm`],
          [path.resolve(__dirname, '../lib/core/office/WebOfficeWorker.br.mem'), `${resourceDir}/officeResource`],
        );
        resourcesForZip.push(
          [`${resourceDir}/office`],
          [`${resourceDir}/officeAsm`],
      ...
      if (type === 'n') {
        ...
        filesToRelocate.push(
          ...
          [path.resolve(__dirname, '../lib/core/pdf/lean/PDFNetC.br.js.mem'), `${resourceDir}/asm/lean`],
      ...
      // If they do need the full API
        ...
        filesToRelocate.push(
          ...
          [path.resolve(__dirname, '../lib/core/pdf/full/PDFNetC.br.js.mem'), `${resourceDir}/asm/full`],
